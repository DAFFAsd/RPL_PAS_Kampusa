...
import AgendaSidebar from "../../../components/agenda/AgendaGroupSidebar";
...
function GroupAgenda() {
  ...
  let [openAgendaCreateModal, setOpenAgendaCreateModal] = useState(false);
  ...
  let timeShow = () => {
    return (
      ...
      >
        {" "}
        {openAgendaCreateModal && (
          <AgendaCreateModal
            open={openAgendaCreateModal}
            setOpen={setOpenAgendaCreateModal}
          />
        )}
      ...
      <Box className="container">
        <Hidden smUp={true}>
          ...
          <Box sx={{ width: "100%" }}>
              ...
              >
                ...
                >
                  <Button
                    ...
                    onClick={() => setOpenAgendaCreateModal(true)}
                  >
            ...
            {timeRange === "day" ? (
              <AgendaDay hideNavbar setOpen={setOpenAgendaDetailsModal} />
            ) : timeRange === "week" ? (
              <AgendaWeek hideNavbar setOpen={setOpenAgendaDetailsModal} />
            ) : timeRange === "month" ? (
              <AgendaMonth hideNavbar setOpen={setOpenAgendaDetailsModal} />
            ) : (
              <AgendaAgenda hideNavbar />
            )}
          </Box>
        </Hidden>
        <Hidden smDown={true}>

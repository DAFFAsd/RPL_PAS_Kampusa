...
function Home(props) {
  return (
    ...
    >
      <path
        fill={props.color}
        d="M27.3,12.2L17.4,1.5c-0.4-0.5-1-0.8-1.6-1.1C15.3,0.1,14.6,0,14,0c-0.6,0-1.3,0.1-1.9,0.4
	...
	c0.9,0,1.8-0.4,2.5-1c0.7-0.7,1-1.5,1-2.5V13.8C28,13.2,27.8,12.7,27.3,12.2z"
      ...
      <path
        fill={props.color}
        d="M14,17.5c-0.9,0-1.8,0.4-2.5,1c-0.7,0.7-1,1.5-1,2.5v7h7v-7c0-0.9-0.4-1.8-1-2.5C15.8,17.9,14.9,17.5,14,17.5z"
      />
    </svg>
  );
}
